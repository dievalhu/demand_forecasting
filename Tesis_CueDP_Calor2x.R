...
df2 = train[,1:2]
cols <- c("#FFB2B6", "#FF6600", "#00A600", "#FF0000")
...
cols <- c("#FFB2B6", "#FFCC00", "#0000FF", "#FF00CC")
pl <- ggplot(df2 , aes(x = Weeks, color = Variable))
pl <- pl + geom_line(aes(y = Sales, color = "1 Sales"), group = 1)
...
set.seed(2)
m11t = nnetar(Salest, p = 4, lambda="auto")
